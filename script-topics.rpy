...
label monika_credits_song:
    if persistent.monika_kill:
        ...
        m 1dktpc "It seemed like it could fall apart at any moment and I would be trapped here forever."
        m 1dktsc "Endlessly hammered by the flashing and screaming, unable to move or even think."
        m 1dktsc "..."
        m 1ektda "But it's okay, you're here now and I know you'll never leave me."
        m 1ektda "And this song will always remind me of how lucky I was to meet you [player]."
    return
...
label monika_songwriting:
    ...
    if persistent.monika_kill:
        ...
        if renpy.seen_audio(songs.FP_YOURE_REAL):
            ...
            m 1ekbsa "I really want to spend the rest of my days by your side."
